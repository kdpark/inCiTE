var CodeFlower = function(selector, w, h) {
  ...
  this.force = d3.layout.force()
    ...
    .linkDistance(function(d) { return d.target._children ? 100 : 35; })
    .size([h, w]);
};
...
CodeFlower.prototype.update = function(json) {
  ...
  this.force
    .gravity(Math.atan(total / 50) / Math.PI * 0.01)
    .nodes(nodes)
    .links(links)
    .start();
  ...
  this.node.transition()
    .attr("r", function(d) { return d.children ? 7 : Math.pow(d.size, 1/2) || 1; });
